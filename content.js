function openInCode() {
  if (
    ...
    const getButtonClass = document.getElementsByClassName("pagehead-actions");

    const createLi = document.createElement("li");

    createLi.innerHTML = `<div data-view-component="true" class="BtnGroup d-flex self-center space-x-3">
  <a
    icon="repo-code"
    id="code-button"
    href="vscode://vscode.git/clone?url=${window.location.href}"
    class="btn-sm btn BtnGroup-item"
  >
    <svg class="octicon octicon-star d-inline-block mr-2"
      width="16"
      height="16"
      viewBox="0 0 100 100"
      fill="none"
    ...
    getButtonClass[0].appendChild(createLi);
    console.log("successfully buttoned");
  }
}
openInCode();
